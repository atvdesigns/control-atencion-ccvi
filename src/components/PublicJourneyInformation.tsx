...
export const PublicJourneyInformation = ({
  ...
  if (!showRequirements && !showPaymentMethods) return null;

  const unavailablePaymentMessage =
    unavailableMethods.length === 1 && unavailableMethods[0].paymentMethodId === "cheque"
      ? "No se aceptan cheques."
      : `No se aceptan los siguientes medios de pago: ${unavailableMethods
